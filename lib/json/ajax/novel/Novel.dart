...
class Novel {
  ...
  factory Novel.fromJson(Map<String, dynamic> json) => Novel(
    ...
    suggestedSettings: json['suggestedSettings'].map((k,v)=>MapEntry(k,_SuggestedSettings.fromJson(v))),
    ...
    seriesNavData: json['seriesNavData'].map((k,v)=>MapEntry(k,Placeholder.fromJson(v))),
